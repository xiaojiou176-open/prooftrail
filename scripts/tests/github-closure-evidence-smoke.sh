...
case "$endpoint" in
  repos/xiaojiou176-open/prooftrail)
    cat <<'JSON'
{"name":"prooftrail","description":"Auditable browser automation platform for repeatable runs, inspectable evidence, and recovery-ready workflows.","homepage":"","has_discussions":true,"topics":["browser-automation","developer-tools","e2e-testing","fastapi","mcp","playwright","reproducibility","workflow-automation"],"default_branch":"main","open_issues_count":0,"owner":{"login":"xiaojiou176-open","type":"Organization"}}
JSON
    ;;
