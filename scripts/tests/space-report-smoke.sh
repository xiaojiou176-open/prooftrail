...
mkdir -p "$repo_root/configs/governance" "$runtime_root/temp/session-a" "$runtime_root/logs/preflight/run-1" "$runtime_root/artifacts/runs/sample-run" "$runtime_root/container-home/cache" "$home_root/.cache/pnpm/prooftrail/store"
