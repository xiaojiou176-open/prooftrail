...
test("ci workflow routes remaining required Linux/Web jobs through repo-owned container tasks", () => {
  ...
  const coreSection = getJobSection(CI_WORKFLOW, "core_contract_load")
  expectRoute(coreSection, "live-smoke", "ci-live-smoke")
  expectRoute(coreSection, "gemini-web-audit", "ci-gemini-web-audit")
